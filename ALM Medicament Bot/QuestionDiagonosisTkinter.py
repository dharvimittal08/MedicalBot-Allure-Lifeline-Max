...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Allure Lifeline Max (ALM)", bg="PeachPuff2", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Develop by:", bg="slateblue4", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="SANJANA SINGLA", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="DHARVI MITTAL", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
...
#        messagebox.showinfo("Failure", self.username1+":"+password1)
        ...
        if username1 in list_of_files:
            ...
            messagebox.showinfo("Failure!", "User not found or sign up for new user")
